    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "visibleToMaintenanceStaffs",
                    models.ManyToManyField(
                        related_name="accessToFiles", to="domain.maintenancestaff"
                    ),
                ),
                (
                    "maintenanceTicket",
                    models.ForeignKey(
                        ...
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="files",
                        to="domain.maintenanceticket",
                    ),
                ),
                (
                    "visibleToSecurityStaffs",
                    models.ManyToManyField(
                        related_name="accessToFiles", to="domain.securitystaff"
                    ),
                ),
                (
                    "visibleToStaffs",
                    models.ManyToManyField(
                        related_name="accessToFiles", to="domain.staff"
                    ),
                ),
                (
                    "visibleToStudents",
                    models.ManyToManyField(
                        related_name="accessToFiles", to="domain.student"
                    ),
                ),
            ],
            options={
